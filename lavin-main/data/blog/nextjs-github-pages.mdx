...
Nah, kali ini kita akan mencoba SSG di Next.js yang akan membuat static site dan men-deploy-nya ke personal github pages(e.g https://LAV1N.github.io) dan kita akan menggunakan github actions untuk automasi proses build dan deploy ke pages kita.

## Prepare github repositories

Yang pertama kita harus membuat repo di github dengan nama **username.github.io**. Misalnya username saya adalah [Lavin](https://github.com/LAV1N) maka saya akan membuat repo dengan nama kelilipan.github.io. Semua file yang terdapat dalam repository tersebut akan dirender/dapat diakses melalui https://LAV1N.github.io.
...
**Selesai**, aplikasi Next.js berhasil di-deploy ke github pages dan dapat diakses melalui [https://LAV1N.github.io/](https://LAV1N.github.io/).
